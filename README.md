...
([extensions/work.md](../soulstream/../soul-hq/02-DESIGN/soulstream-workloads/extensions/work.md)) defines
...
the record; soulstream-workloads is the room.

## Status

**Phase 1 complete — M1.1, M1.2, and M1.3 have landed.** The opening
substrate question is settled ([journey
0002](../soul-hq/04-JOURNEY/0002-soulstream-workloads-the-substrate-decision.md)): after a live
[NEX](https://github.com/synadia-io/nex) spike and source read, **soulstream-workloads
...
[`0001-soulstream-workloads-runtime.md`](../soul-hq/02-DESIGN/soulstream-workloads/0001-soulstream-workloads-runtime.md), and the
Go module `github.com/impire-io/soulstream-workloads` now exists and runs.

What already works:

- **M1.1 — an agent runs** ([journey
  0004](../soul-hq/04-JOURNEY/0004-soulstream-workloads-the-first-agent-runs.md)): soulstream-workloads launches an
...
- **M1.2 — a tool answers** ([journey
  0005](../soul-hq/04-JOURNEY/0005-soulstream-workloads-a-tool-answers.md)): an agent discovers a launched
...
- **M1.3 — a second wall** ([journey
  0007](../soul-hq/04-JOURNEY/0020-soulstream-workloads-a-second-wall.md)): the byte-identical declarations
...
| [`../soul-hq/02-DESIGN/soulstream-workloads/`](../soul-hq/02-DESIGN/soulstream-workloads/README.md) | Architecture & feature designs |
...
Code lives at the repo root as the Go module `github.com/impire-io/soulstream-workloads`;
