...
- [ ] T018 [US1] Document [concept(s) introduced by this story] in docs/ (ELI5 — plain words, everyday analogy)
...
- [ ] T025 [US2] Document [concept(s) introduced by this story] in docs/ (ELI5 — plain words, everyday analogy)
...
- [ ] T031 [US3] Document [concept(s) introduced by this story] in docs/ (ELI5 — plain words, everyday analogy)
...
- `docs/` task (ELI5) MUST be complete before the story is considered done (Constitution Principle III)
